...
- **Generation Pipeline** — Watch `sa auto transformer-paper.pdf` extract, generate, and output a complete skill pack in real-time
- **Interactive Quiz** — Experience a 5-question hard-difficulty quiz session with scenario, comparison, and fill-in-the-blank questions
- **Output Explorer** — Browse the 12-section study guide, key concepts, glossary, flashcards (click to reveal), and practice exercises

<details><summary><b>Can't open the link? Run locally</b></summary>

```bash
# Clone the repo and open the demo directly in your browser
